...
extern int Music_FillAudioBuffer(int16_t *buffer, int32_t numSamples);
...
extern int mix_UpdateBuffer(int16_t *buffer, int32_t numSamples);
...
int current_format = FORMAT1_UNKNOWN;
