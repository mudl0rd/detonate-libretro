...
void GetLoopInformation(slaveChn_t *sc)
{
	...
	else
	{
		...
		LoopMode = (LoopMode & SMPF_LOOP_PINGPONG) ? LOOP_PINGPONG_IT : LOOP_FORWARDS; // 8bb: set loop type (Ping-Pong or Forwards)
	}
...
int Music_FillAudioBuffer(int16_t *buffer, int32_t numSamples)
{
	if (!Song.Playing)
	{
